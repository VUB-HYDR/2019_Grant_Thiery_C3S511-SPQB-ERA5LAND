...
# mask starting file
cdo ifthen $maskDIR/era5-land_lakemask.nc $scratchDIR/mixlayertemp_1981_2019_unmasked.nc $scratchDIR/mixlayertemp_daily_1981_2019.nc
...
cdo timmin $scratchDIR/mixlayertemp_daily_1981_2019.nc $scratchDIR/minfile.nc


cdo timmax $scratchDIR/mixlayertemp_daily_1981_2019.nc $scratchDIR/maxfile.nc
...
for PERC in "${PERCENTs[@]}"; do
    ...
    cdo -b F64 -O -L timpctl,$((${PERC}+0)) $scratchDIR/mixlayertemp_daily_1981_2019.nc $scratchDIR/minfile.nc $scratchDIR/maxfile.nc $outDIR/percentiles/era5-land_lakes_mixlayertemp_percentile_${PERC}_1981_2019.nc

    cdo -b F64 -O -L fldmean $outDIR/percentiles/era5-land_lakes_mixlayertemp_percentile_${PERC}.nc $outDIR/percentiles/era5-land_lakes_mixlayertemp_percentile_${PERC}_fldmean_1981_2019.nc

    cdo -b F64 -O -L fldstd $outDIR/percentiles/era5-land_lakes_mixlayertemp_percentile_${PERC}.nc $outDIR/percentiles/era5-land_lakes_mixlayertemp_percentile_${PERC}_fldstd_1981_2019.nc

done


rm $scratchDIR/mixlayertemp_daily_1981_2019.nc
